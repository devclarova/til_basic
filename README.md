...
- load는 이미지 등의 용량이 큰 파일이 로드되면 실행하도록 함.
...
- 원본 Swiper 예제의 버튼의 `클래스명`을 꼭 알아내서 활용하자.
...
![Image](https://github.com/user-attachments/assets/8d6f8693-6bea-4248-9bd5-ac41cc3a486c)

- `Settings 메뉴` 선택

![Image](https://github.com/user-attachments/assets/39696a56-d4e6-4ce4-9ccb-f4c55058565d)
...
- scss 폴더에 `_val.scss` 파일 만들기(파일명은 자유)
...
- 변수 사용 시 `@import "val";` `_` 반드시 제거하고 파일명만 작성
...
User-agent: *
Allow: /
Sitemap: https://til-basic-theta.vercel.app/sitemap.xml
```
